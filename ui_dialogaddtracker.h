...
public:
    ...
    void setupUi(QDialog *DialogAddTracker)
    {
        if (DialogAddTracker->objectName().isEmpty())
            DialogAddTracker->setObjectName(QString::fromUtf8("DialogAddTracker"));
    ...
    {
        DialogAddTracker->setWindowTitle(QApplication::translate("DialogAddTracker", "Dialog", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("DialogAddTracker", "Tracker name:", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("DialogAddTracker", "Tracker address:", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
